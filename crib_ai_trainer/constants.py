...
DEFAULT_PEGGING_LABEL_MODE = _getenv_str("PEGGING_LABEL_MODE", "rollout1")
...
DEFAULT_BENCHMARK_PLAYERS = _getenv_str("BENCHMARK_PLAYERS", "NeuralRegressionPlayer,beginner")
DEFAULT_FALLBACK_PLAYER = _getenv_str("FALLBACK_PLAYER", "beginner")
