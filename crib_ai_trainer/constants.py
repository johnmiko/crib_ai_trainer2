...
DEFAULT_DATASET_VERSION = _getenv_str("DATASET_VERSION", "discard_v6")
DEFAULT_DATASET_RUN_ID = _getenv_str("DATASET_RUN_ID", "")
DEFAULT_MODEL_VERSION = _getenv_str("MODEL_VERSION", "discard_v6")
...
DEFAULT_PEGGING_DATA_DIR = _getenv_str("PEGGING_DATA_DIR", "il_datasets\\discard_v5\\001")
...
DEFAULT_WIN_PROB_MODE = _getenv_str("WIN_PROB_MODE", "off")
...
DEFAULT_GAMES_PER_LOOP = _getenv_int("GAMES_PER_LOOP", 100)
...
DEFAULT_BENCHMARK_GAMES = _getenv_int("BENCHMARK_GAMES", 100)
