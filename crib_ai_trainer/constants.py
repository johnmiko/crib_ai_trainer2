...
DEFAULT_DATASET_VERSION = _getenv_str("DATASET_VERSION", "discard_v7")
DEFAULT_DATASET_RUN_ID = _getenv_str("DATASET_RUN_ID", "")
DEFAULT_MODEL_VERSION = _getenv_str("MODEL_VERSION", "discard_v7")
...
DEFAULT_PEGGING_DATA_DIR = _getenv_str("PEGGING_DATA_DIR", "")
DEFAULT_MODEL_TYPE = _getenv_str("MODEL_TYPE", "mlp")
DEFAULT_MLP_HIDDEN = _getenv_str("MLP_HIDDEN", "128,64,32")
...
DEFAULT_WIN_PROB_MODE = _getenv_str("WIN_PROB_MODE", "rollout")
DEFAULT_WIN_PROB_ROLLOUTS = _getenv_int("WIN_PROB_ROLLOUTS", 16)
DEFAULT_WIN_PROB_MIN_SCORE = _getenv_int("WIN_PROB_MIN_SCORE", 90)
DEFAULT_PEGGING_EV_MODE = _getenv_str("PEGGING_EV_MODE", "off")
DEFAULT_PEGGING_EV_ROLLOUTS = _getenv_int("PEGGING_EV_ROLLOUTS", 8)
DEFAULT_MAX_BUFFER_GAMES = _getenv_int("MAX_BUFFER_GAMES", 500)

DEFAULT_GAMES_PER_LOOP = _getenv_int("GAMES_PER_LOOP", 1000)
DEFAULT_IL_WORKERS = _getenv_int("IL_WORKERS", 10)
DEFAULT_IL_GAMES_PER_WORKER = _getenv_int("IL_GAMES_PER_WORKER", 100)
DEFAULT_LOOPS = _getenv_int("LOOPS", 100)
DEFAULT_EPOCHS = _getenv_int("EPOCHS", 5)
DEFAULT_BENCHMARK_GAMES = _getenv_int("BENCHMARK_GAMES", 1000)
DEFAULT_BENCHMARK_WORKERS = _getenv_int("BENCHMARK_WORKERS", 10)
DEFAULT_BENCHMARK_GAMES_PER_WORKER = _getenv_int("BENCHMARK_GAMES_PER_WORKER", 100)
